...
bash train_and_eval.sh SAET_L1 PixelShuffleConv1DAutoencoderWithTransformer L1Loss --without-shuffle
bash train_and_eval.sh SAET_SL1 PixelShuffleConv1DAutoencoderWithTransformer SmoothL1Loss --without-shuffle
