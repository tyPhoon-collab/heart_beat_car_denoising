...
bash train_and_eval.sh AE_L1 Conv1DAutoencoder L1Loss BATCH_SIZE GAIN
bash train_and_eval.sh AE_SL1 Conv1DAutoencoder CombinedLoss BATCH_SIZE GAIN

bash train_and_eval.sh P_AE_L1 Conv1DAutoencoder L1Loss BATCH_SIZE GAIN --with-progressive-gain
bash train_and_eval.sh P_AE_SL1 Conv1DAutoencoder CombinedLoss BATCH_SIZE GAIN --with-progressive-gain

bash train_and_eval.sh SAE_L1 PixelShuffleConv1DAutoencoder L1Loss BATCH_SIZE GAIN
bash train_and_eval.sh SAE_SL1 PixelShuffleConv1DAutoencoder CombinedLoss BATCH_SIZE GAIN
